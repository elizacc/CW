...
\newpage
	...
	\section{Введение}
	\input{chapters/1_begin.tex}
	\newpage
	
	\section{Методы интерпретации}
	\subsection{PDP}
	\input{chapters/3_pdp.tex}
	\subsubsection{Принцип работы}
	\input{chapters/3_1pdp.tex}
	\subsubsection{Реализация}
	\input{chapters/3_2pdp.tex}
	\subsection{LIME}
	\input{chapters/3_lime.tex}
	\subsubsection{Принцип работы}
	\input{chapters/3_1lime.tex}
	\subsubsection{Реализация}
	\input{chapters/3_2lime.tex}
	\subsection{SHAP}
	\input{chapters/3_shap.tex}
	\subsubsection{Принцип работы}
	\input{chapters/3_1shap.tex}
	\subsubsection{Реализация}
	\input{chapters/3_2shap.tex}
	\newpage

	\section{Анализ данных и интерпретация}
	\input{chapters/5_desc.tex}
	\subsection{Данные}
	\input{chapters/5_data.tex}
	\subsection{Модели}
	\input{chapters/5_models.tex}
	\newpage
	\subsection{Интерпретация результатов}
	\input{chapters/5_inter.tex}
	\newpage
	
	\section{Заключение}
	\input{chapters/7_end.tex}
	\newpage
