...
\newpage
	...
	\subsection{PDP}
	\input{chapters/2_pdp.tex}
	\subsubsection{Принцип работы}
	\input{chapters/2_1pdp.tex}
	\subsubsection{Реализация}
	\input{chapters/2_2pdp.tex}
	\subsection{LIME}
	\input{chapters/2_lime.tex}
	\subsubsection{Принцип работы}
	\input{chapters/2_1lime.tex}
	\subsubsection{Реализация}
	\input{chapters/2_2lime.tex}
	\subsection{SHAP}
	\input{chapters/2_shap.tex}
	\subsubsection{Принцип работы}
	\input{chapters/2_1shap.tex}
	\subsubsection{Реализация}
	\input{chapters/2_2shap.tex}
	\newpage

	\section{Пример применения}
	\input{chapters/3desc.tex}
	\newpage
	\subsection{PDP}
	\input{chapters/3pdp.tex}
	\newpage
	\subsection{LIME}
	\input{chapters/3lime.tex}
	\subsection{SHAP}
	\input{chapters/3shap.tex}
	\newpage
	...
	\input{chapters/3_inter.tex}
	\newpage
	
	\section{Заключение}
	\input{chapters/4_end.tex}
	\newpage
